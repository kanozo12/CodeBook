		...
		<nav>
			<ul class="pagination justify-content-center">
				<c:if test="${criteria.prev}">
					<li class="page-item">
						<a href="/board/list3${criteria.getQuery(criteria.start - 1)}" class="page-link" aria-label="Previous"> 
				...
				<c:if test="${criteria.next}">
					<li class="page-item">
						<a href="/board/list3${criteria.getQuery(criteria.end + 1)}" class="page-link" aria-label="Next"> 
